...
public class MainGame : MonoBehaviour
{
    ...
    public void GetMainData()
    {
        ...
        {
            chart = new float[140][];
            chart[0] = new float[3] { 1.088f, 11.0f, -35.0f };
            chart[1] = new float[3] { 1.877333f, 10.0f, -35.0f };
            chart[2] = new float[3] { 2.581333f, 10.0f, -34.0f };
            chart[3] = new float[3] { 3.072f, 10.0f, -33.0f };
            chart[4] = new float[3] { 3.861333f, 10.0f, -32.0f };
            chart[5] = new float[3] { 4.586667f, 10.0f, -31.0f };
            chart[6] = new float[3] { 5.056f, 10.0f, -30.0f };
            chart[7] = new float[3] { 5.866667f, 10.0f, -29.0f };
            chart[8] = new float[3] { 6.613333f, 10.0f, -28.0f };
            chart[9] = new float[3] { 7.061333f, 10.0f, -27.0f };
            chart[10] = new float[3] { 7.872f, 11.0f, -27.0f };
            chart[11] = new float[3] { 8.576f, 12.0f, -27.0f };
            chart[12] = new float[3] { 9.066667f, 13.0f, -27.0f };
            chart[13] = new float[3] { 9.856f, 14.0f, -27.0f };
            chart[14] = new float[3] { 10.60267f, 15.0f, -27.0f };
            chart[15] = new float[3] { 11.072f, 16.0f, -27.0f };
            chart[16] = new float[3] { 11.84f, 17.0f, -27.0f };
            chart[17] = new float[3] { 12.58667f, 17.0f, -26.0f };
            chart[18] = new float[3] { 13.03467f, 17.0f, -25.0f };
            chart[19] = new float[3] { 13.84533f, 17.0f, -24.0f };
            chart[20] = new float[3] { 14.54933f, 17.0f, -23.0f };
            chart[21] = new float[3] { 15.01867f, 17.0f, -22.0f };
            chart[22] = new float[3] { 15.82933f, 17.0f, -21.0f };
            chart[23] = new float[3] { 16.55467f, 17.0f, -20.0f };
            chart[24] = new float[3] { 17.04533f, 16.0f, -20.0f };
            chart[25] = new float[3] { 17.83467f, 15.0f, -20.0f };
            chart[26] = new float[3] { 18.53867f, 14.0f, -20.0f };
            chart[27] = new float[3] { 19.05067f, 13.0f, -20.0f };
            chart[28] = new float[3] { 19.86133f, 12.0f, -20.0f };
            chart[29] = new float[3] { 20.65067f, 11.0f, -20.0f };
            chart[30] = new float[3] { 21.03467f, 10.0f, -20.0f };
            chart[31] = new float[3] { 21.84533f, 10.0f, -19.0f };
            chart[32] = new float[3] { 22.54933f, 9.0f, -19.0f };
            chart[33] = new float[3] { 23.06133f, 8.0f, -19.0f };
            chart[34] = new float[3] { 23.85067f, 7.0f, -19.0f };
            chart[35] = new float[3] { 24.55467f, 6.0f, -19.0f };
            chart[36] = new float[3] { 25.04533f, 5.0f, -19.0f };
            chart[37] = new float[3] { 25.856f, 4.0f, -19.0f };
            chart[38] = new float[3] { 26.56f, 3.0f, -19.0f };
            chart[39] = new float[3] { 27.02933f, 2.0f, -19.0f };
            chart[40] = new float[3] { 27.84f, 1.0f, -19.0f };
            chart[41] = new float[3] { 28.58667f, 1.0f, -18.0f };
            chart[42] = new float[3] { 29.056f, 1.0f, -17.0f };
            chart[43] = new float[3] { 29.86667f, 0.0f, -17.0f };
            chart[44] = new float[3] { 30.592f, -1.0f, -17.0f };
            chart[45] = new float[3] { 31.06133f, -1.0f, -18.0f };
            chart[46] = new float[3] { 31.872f, -1.0f, -19.0f };
            chart[47] = new float[3] { 32.576f, -1.0f, -20.0f };
            chart[48] = new float[3] { 33.04533f, 0.0f, -20.0f };
            chart[49] = new float[3] { 33.856f, 1.0f, -20.0f };
            chart[50] = new float[3] { 34.53867f, 2.0f, -20.0f };
            chart[51] = new float[3] { 35.05067f, 3.0f, -20.0f };
            chart[52] = new float[3] { 35.88267f, 4.0f, -20.0f };
            chart[53] = new float[3] { 36.52267f, 4.0f, -19.0f };
            chart[54] = new float[3] { 37.03467f, 5.0f, -19.0f };
            chart[55] = new float[3] { 37.84533f, 6.0f, -19.0f };
            chart[56] = new float[3] { 38.54933f, 7.0f, -19.0f };
            chart[57] = new float[3] { 39.04f, 8.0f, -19.0f };
            chart[58] = new float[3] { 39.85067f, 9.0f, -19.0f };
            chart[59] = new float[3] { 40.53333f, 10.0f, -19.0f };
            chart[60] = new float[3] { 41.04533f, 11.0f, -19.0f };
            chart[61] = new float[3] { 42.048f, 12.0f, -19.0f };
            chart[62] = new float[3] { 43.02934f, 13.0f, -19.0f };
            chart[63] = new float[3] { 44.096f, 14.0f, -19.0f };
            chart[64] = new float[3] { 45.07733f, 15.0f, -19.0f };
            chart[65] = new float[3] { 46.08f, 16.0f, -19.0f };
            chart[66] = new float[3] { 47.04f, 17.0f, -19.0f };
            chart[67] = new float[3] { 48.04267f, 18.0f, -19.0f };
            chart[68] = new float[3] { 49.04533f, 19.0f, -19.0f };
            chart[69] = new float[3] { 50.58133f, 20.0f, -19.0f };
            chart[70] = new float[3] { 51.072f, 20.0f, -18.0f };
            chart[71] = new float[3] { 52.58667f, 20.0f, -17.0f };
            chart[72] = new float[3] { 53.09867f, 20.0f, -16.0f };
            chart[73] = new float[3] { 55.04f, 20.0f, -15.0f };
            chart[74] = new float[3] { 56.064f, 20.0f, -14.0f };
            chart[75] = new float[3] { 57.04533f, 21.0f, -14.0f };
            chart[76] = new float[3] { 58.06933f, 22.0f, -14.0f };
            chart[77] = new float[3] { 59.02934f, 23.0f, -14.0f };
            chart[78] = new float[3] { 60.05333f, 23.0f, -13.0f };
            chart[79] = new float[3] { 61.07733f, 23.0f, -12.0f };
            chart[80] = new float[3] { 62.05867f, 23.0f, -11.0f };
            chart[81] = new float[3] { 63.06133f, 23.0f, -10.0f };
            chart[82] = new float[3] { 64.064f, 23.0f, -9.0f };
            chart[83] = new float[3] { 65.024f, 23.0f, -8.0f };
            chart[84] = new float[3] { 66.58134f, 23.0f, -7.0f };
            chart[85] = new float[3] { 67.05067f, 23.0f, -6.0f };
            chart[86] = new float[3] { 68.544f, 23.0f, -5.0f };
            chart[87] = new float[3] { 69.056f, 23.0f, -4.0f };
            chart[88] = new float[3] { 71.104f, 23.0f, -3.0f };
            chart[89] = new float[3] { 72.064f, 24.0f, -3.0f };
            chart[90] = new float[3] { 73.088f, 25.0f, -3.0f };
            chart[91] = new float[3] { 74.06934f, 26.0f, -3.0f };
            chart[92] = new float[3] { 75.072f, 27.0f, -3.0f };
            chart[93] = new float[3] { 75.88267f, 27.0f, -2.0f };
            chart[94] = new float[3] { 76.58667f, 27.0f, -1.0f };
            chart[95] = new float[3] { 77.09866f, 28.0f, -1.0f };
            chart[96] = new float[3] { 77.86667f, 29.0f, -1.0f };
            chart[97] = new float[3] { 78.57066f, 30.0f, -1.0f };
            chart[98] = new float[3] { 79.04f, 31.0f, -1.0f };
            chart[99] = new float[3] { 79.85067f, 32.0f, -1.0f };
            chart[100] = new float[3] { 80.59734f, 33.0f, -1.0f };
            chart[101] = new float[3] { 81.06667f, 34.0f, -1.0f };
            chart[102] = new float[3] { 81.856f, 35.0f, -1.0f };
            chart[103] = new float[3] { 82.56f, 36.0f, -1.0f };
            chart[104] = new float[3] { 83.072f, 37.0f, -1.0f };
            chart[105] = new float[3] { 83.86134f, 37.0f, -2.0f };
            chart[106] = new float[3] { 84.56533f, 37.0f, -3.0f };
            chart[107] = new float[3] { 85.07733f, 37.0f, -4.0f };
            chart[108] = new float[3] { 85.86667f, 37.0f, -5.0f };
            chart[109] = new float[3] { 86.54933f, 37.0f, -6.0f };
            chart[110] = new float[3] { 87.06133f, 38.0f, -6.0f };
            chart[111] = new float[3] { 87.872f, 38.0f, -7.0f };
            chart[112] = new float[3] { 88.59734f, 38.0f, -8.0f };
            chart[113] = new float[3] { 89.06667f, 38.0f, -9.0f };
            chart[114] = new float[3] { 89.856f, 38.0f, -10.0f };
            chart[115] = new float[3] { 90.58134f, 38.0f, -11.0f };
            chart[116] = new float[3] { 91.072f, 38.0f, -12.0f };
            chart[117] = new float[3] { 91.84f, 39.0f, -12.0f };
            chart[118] = new float[3] { 92.58667f, 40.0f, -12.0f };
            chart[119] = new float[3] { 93.07733f, 41.0f, -12.0f };
            chart[120] = new float[3] { 93.86667f, 42.0f, -12.0f };
            chart[121] = new float[3] { 94.592f, 43.0f, -12.0f };
            chart[122] = new float[3] { 95.08266f, 44.0f, -12.0f };
            chart[123] = new float[3] { 95.89333f, 45.0f, -12.0f };
            chart[124] = new float[3] { 96.59734f, 45.0f, -11.0f };
            chart[125] = new float[3] { 97.04533f, 45.0f, -10.0f };
            chart[126] = new float[3] { 97.856f, 45.0f, -9.0f };
            chart[127] = new float[3] { 98.56f, 45.0f, -8.0f };
            chart[128] = new float[3] { 99.05067f, 45.0f, -7.0f };
            chart[129] = new float[3] { 99.86134f, 45.0f, -6.0f };
            chart[130] = new float[3] { 100.5227f, 46.0f, -6.0f };
            chart[131] = new float[3] { 101.0347f, 47.0f, -6.0f };
            chart[132] = new float[3] { 101.8453f, 48.0f, -6.0f };
            chart[133] = new float[3] { 102.5493f, 49.0f, -6.0f };
            chart[134] = new float[3] { 103.04f, 50.0f, -6.0f };
            chart[135] = new float[3] { 103.872f, 51.0f, -6.0f };
            chart[136] = new float[3] { 104.576f, 52.0f, -6.0f };
            chart[137] = new float[3] { 105.088f, 53.0f, -6.0f };
            chart[138] = new float[3] { 105.8347f, 53.0f, -7.0f };
            chart[139] = new float[3] { 106.5813f, 53.0f, -8.0f };
        }
        else if (stageNum == 2)
        {
            chart = new float[137][];
